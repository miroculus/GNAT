...
/**
 * A Stemmer for English using the Porter stemming algorithm.<br>
 * <br>
 * [1] M.F. Porter, 1980, An algorithm for suffix stripping, Program, 14(3) pp 130-137.<br>
 * [2] Karen Sparck Jones and Peter Willet, 1997, Readings in Information Retrieval, San Francisco: Morgan Kaufmann, ISBN 1-55860-454-4.<br>
 * <br>
 * See <a href="http://www.tartarus.org/~martin/PorterStemmer/" target="_top">http://www.tartarus.org/~martin/PorterStemmer/</a>
 *
 * @author Martin Porter ;-), Conrad Plake, Joerg Hakenberg
 */
public class PorterStemmerEN {

	/**
	 * Calculates the stems for all words in the array, and returns an array of all word stems, keeping the ordering.
	 * @param words - array of words
	 * @return array of word stems
	 */
	...
	/**
	 * Calculates the stem for a single word
	 * @param str - a word
	 * @return its stem
	 */
	...
	/**
	 * Step 1a in the Porter stemming algorithm - plural forms of nouns
	 * @param str - a word
	 * @return its reduced form
	 */
	...
	/**
	 * Step 1b in the Porter stemming algorithm -
	 * @param str - a word
	 * @return its reduced form
	 */
	...
	/**
	 * Step 1b2 in the Porter stemming algorithm - at/bl/iz -&gt; ate/ble/ize; double consonant
	 * @param str - a word
	 * @return its reduced form
	 */
	...
	/**
	 * Step 1c in the Porter stemming algorithm - y
	 * @param str - a word
	 * @return its reduced form
	 */
	...
	/**
	 * Step 2 in the Porter stemming algorithm - ational/tional/enci/anci/izer/abli/..
	 * @param str - a word
	 * @return its reduced form
	 */
	...
	/**
	 * Step 3 in the Porter stemming algorithm - icate/ative/alize/..
	 * @param str - a word
	 * @return its reduced form
	 */
	...
	/**
	 * Step 4 in the Porter stemming algorithm - al/ance/ence/er/..
	 * @param str - a word
	 * @return its reduced form
	 */
	...
	/**
	 * Step 5a in the Porter stemming algorithm -
	 * @param str - a word
	 * @return its reduced form
	 */
	...
	/**
	 * Step 5b in the Porter stemming algorithm -
	 * @param str - a word
	 * @return its reduced form
	 */
	...
	*/
	...
	/**
	 * Does the string contain a vowel? Checks for a, e, i, o, u, and y.
	 * @param str - a word
	 * @return true if it does
	 */
	...
	/**
	 * Is this character a vowel? Checks for a, e, i, o, and u.
	 * @param c
	...
	/**
	 * Does the string end with a double consonant?
	 * @param str - a word
	 * @return  true if it does
	 */
	protected static boolean endsWithDoubleConsonant(String str) {
	...
	/**
	 * Returns a CVC measure for the string - how many VC's are there in this string?
	 * @param str - a word
	 * @return CVC measure
	 */
	...
	/**
	 * Does the string end with a CVC motif (consonant-vowel-consonant)? Skips w,x, and y at the first C.
	 * @param str - a word
	 * @return  true if it does
	 */
	...
	public static void main(String[] args){
		...
		System.out.println(stem("microscope"));
		System.out.println(stem("microscopy"));
